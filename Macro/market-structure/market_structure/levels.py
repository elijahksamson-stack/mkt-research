...
price, that agreement is the signal, not any single line (Part 6). Pure
math, no I/O — a verbatim port of RiskRewardAnalyzer's _build_channels /
_build_fibonacci_levels / _build_anchored_vwap / _build_volume_profile /
_build_round_levels / _collect_all_levels / _build_convergence_clusters.
"""
...
from market_structure.indicators import Pivot
