...
family in this package builds on. Pure math over numpy arrays, no I/O, so
it's fully unit-testable offline. Verbatim port of RiskRewardAnalyzer's
_atr / _realized_vol / _relative_volume / _find_local_extrema /
_build_pivots_with_macd_filter, distilled in /Users/elisamson/Desktop/wisdom/rr.txt
Parts 2-3 (the source-of-truth spec this module follows constant-for-constant).
"""
