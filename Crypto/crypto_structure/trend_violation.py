...
This is the refinement Macro/market-structure added beyond rr.txt's original
...
trendline just broke. This matters at least as much for crypto, where
sentiment-driven breakdowns can undercut a rising support line well before
a lagging R:R snapshot catches up.
...
the latest close has undercut it, and for how many consecutive bars. Pure
math, bar-indexed rather than calendar-indexed, so it needs no
...
from crypto_structure.trendlines import TrendlineSegment, build_pivot_pair_trendlines
