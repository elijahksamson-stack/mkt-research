...
from crypto_structure.trend_violation import detect_trend_violation
...
def _ascending_support_then_stall(n=80, stall_from=51):
    ...
    line -- the "undercut support of uptrend" setup."""
...
class TestDetectTrendViolation:
    ...
    def test_reuses_precomputed_pivot_pair_lines_when_provided(self):
        from crypto_structure.trendlines import build_pivot_pair_trendlines
