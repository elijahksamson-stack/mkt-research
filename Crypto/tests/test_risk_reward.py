...
from crypto_structure.indicators import InsufficientDataError
from crypto_structure.risk_reward import analyze
...
class TestAnalyze:
    def test_raises_below_minimum_bars(self):
        ...
        with pytest.raises(InsufficientDataError):
            analyze("BTC-USD", high, low, close, volume)

    def test_returns_a_fully_populated_report(self):
        high, low, close, volume = _synthetic_ohlcv()
        report = analyze("BTC-USD", high, low, close, volume)
        assert report.ticker == "BTC-USD"
    ...
    def test_rr_ratio_is_nonnegative(self):
        ...
        report = analyze("ETH-USD", high, low, close, volume)
    ...
    def test_stop_sits_below_last_close(self):
        ...
        report = analyze("SOL-USD", high, low, close, volume)
